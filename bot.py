...
# ==================== BOT CONFIGURATION ====================
TELEGRAM_BOT_TOKEN = os.environ.get("TELEGRAM_BOT_TOKEN", "8352132120:AAFGtA_ChS-diB3NNYXeDUsRCqP7QFHmvCc")

SHRINK_API = os.environ.get("SHRINK_API", "860321374ebd153019407a635e12a63b56feadce")
ALLOWED_GROUP_IDS_RAW = os.environ.get("ALLOWED_GROUP_IDS", "-1003550876057,-1003258005381")
ALLOWED_GROUP_IDS = [int(x.strip()) for x in ALLOWED_GROUP_IDS_RAW.split(",") if x.strip()]
REDIRECT_LINK = os.environ.get("REDIRECT_LINK", "https://t.me/SulavXMRCLIKES")
OWNERS = os.environ.get("OWNERS", "@MRCxCheats and @sulav_codex_ff")

# Super admins — these IDs are always admins and can never be removed
SUPER_ADMINS_RAW = os.environ.get("SUPER_ADMINS", "8399116292,5938491424")
SUPER_ADMINS = {int(x.strip()) for x in SUPER_ADMINS_RAW.split(",") if x.strip()}

# ==================== ADMIN / MAINTENANCE / WARNING SYSTEM ====================
DATA_FILE = os.path.join(CURRENT_DIR, "bot_data.json")
WARNING_THRESHOLD = 3
...
async def auto_scheduler():
    ...
    while True:
        ...
        await asyncio.sleep(max(AUTO_INTERVAL_HOURS * 3600, 3600))
